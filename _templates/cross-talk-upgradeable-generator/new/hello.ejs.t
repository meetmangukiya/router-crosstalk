...
abstract contract <%=name%> is Initializable , ContextUpgradeable , iRouterCrossTalkUpgradeable, ERC165Upgradeable {
    ...
    function __RouterCrossTalkUpgradeable_init( ) internal initializer {
